...
class EOR_Instruction(Instruction):
    ...
    Performs a bitwise exclusive OR operation between two registers or a register and an immediate value.
    """

    def __init__(self, destination, reg1, reg2_or_immediate):
        """
        Initialize the EOR instruction.
