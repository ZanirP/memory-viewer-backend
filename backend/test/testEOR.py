...
class TestInstructionParser(unittest.TestCase):
    ...
    def test_parser_eor_instruction(self):
        """
        Test parsing of the EOR instruction.
        """
        ...
        self.assertEqual(instruction.__class__.__name__, "EOR_Instruction")
    ...
    def test_execute_eor_instruction(self):
        """
        Test execution of the EOR instruction.
        """
        ...
        self.assertEqual(self.memory_db["registers"].get("X0"), 6)
        
    def test_revert_eor_instruction(self):
        """
        Test reversion of the EOR instruction.
        """
        self.memory_db["registers"].set("X1", 5)
        self.memory_db["registers"].set("X2", 3)
        parser = InstructionParser(self.memory_db["Instructions"])
